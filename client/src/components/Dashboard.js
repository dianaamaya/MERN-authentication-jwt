    ...
    return (
      <div>
        ...
        <FacebookLogin
          ...
          disabled={true}
          render={renderProps => (
            <button className="btn btn-primary mr-2" onClick={renderProps.onClick} disabled={this.props.dashboard.methods.includes('facebook') ? true : false}>Link with Facebook</button>
          )}
