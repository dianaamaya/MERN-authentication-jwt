...
const userController = rewire('../../../server/controllers/user.controller.js');
...
describe('Users controller', () => {
  ...
  describe('dashboard', () => {
    it('should return resource and methods when it is called', async () => {
  ...
  /*describe('signIn', () => {
    it('should return status and success when it is colled', async () => {
      sandbox.spy(res, 'json');
